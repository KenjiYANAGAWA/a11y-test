    ...
    switch (currentLocation) {
        ...
        case '/products/mh40-wireless-ear-pads':
            {
                ...
                try {
                    ...
                    document.querySelector('.price-list.price-list--lg').firstElementChild.innerHTML = `<span class="sr-only">Sale price</span>$${Number(ogPrice.replace('$','')) - 11}.99 <small style="color: rgb(151 7 7)"><s>${ogPrice}</s></small>`
                } catch (error) {
      ...
      `)
                ...
                try {
                    ...
                    var headingsIcon = document.querySelectorAll('.text-with-icons__text-wrapper .prose .h5');
                    headingsIcon.forEach(heading => {
                    ...
                    var finalQuestion = document.querySelector('.rich-text__wrapper p');
                    var newFinalQ = document.createElement('h1');
                    newFinalQ.innerHTML = finalQuestion.innerHTML;
                    newFinalQ.classList = finalQuestion.classList;
                    finalQuestion.parentElement.replaceChild(newFinalQ, finalQuestion);
