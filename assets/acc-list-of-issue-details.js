...
100 Done
0 Deved
8 Not Implemented yet",Link to Issue,Scenario,Step,Level,"Criterion
...
1,FALSE,Done: Verified by PM,https://a11y-test.com/products/mh40-wireless-silver-metal-navy-coated-canvas,S2: Searching a Product and adding to Cart,,A,1.1.1 Non-text Content,Image does not provide a text alternative,"**MH40 Wireless (Silver Metal / Navy Coated Canvas)** first product image has a bad alt text. It is just its original file name, **20230518.jpg**",Implicit,"F30: Failure of Success Criterion 1.1.1 and 1.2.1 due to using text alternatives that are not alternatives (e.g., filenames or placeholder text)",67.06%,2.46%,,,Major,TRUE,FALSE,,
...
Whatever the tabs it displays, only the results in the **last** tab receive keyboard focus.",Explicit,F54: Failure of Success Criterion 2.1.1 due to using only pointing-device-specific event handlers (including gesture) for a function,63.53%,3.37%,,,Blocking,FALSE,FALSE,,
...
**50% off sale until July**",Explicit,F50: Failure of Success Criterion 2.2.2 due to a script that causes a blink effect without a mechanism to stop the blinking at 5 seconds or less,17.65%,0.40%,,,Blocking,TRUE,FALSE,,
...
**Submit a review** receives focus earlier than other input fields inside **Write a review** section.",Implicit,C27: Making the DOM order match the visual order,78.82%,4.94%,,,Major,FALSE,FALSE,,
...
81,FALSE,Not Implemented yet,https://a11y-test.com/cart,S3: View Cart,,A,2.5.4 Motion Actuation,Motion actuation cannot be disabled,Shaking the phone clears the cart items but cannot be disabled,Explicit,F106: Failure due to inability to deactivate motion actuation,0.00%,0.00%,,,Major,FALSE,FALSE,,
...
Does not occur on Login page",Implicit,,0.00%,0.00%,,,Major,TRUE,FALSE,,
...
Form does not show password formatting requirement beforehand",Implicit,G177: Providing suggested correction text,40.00%,0.98%,,,Minor,TRUE,FALSE,,
...
Correct behavior can be seen on a11y-test.com/cart",Explicit,F103: Failure of Success Criterion 4.1.3 due to providing status messages that cannot be programmatically determined through role or properties,2.35%,0.09%,,,Major,TRUE,FALSE,,
...
128,TRUE,Done: Verified by PM,https://a11y-test.com,S1: Explore the site for the first time,,A,2.1.1 Keyboard,Control does not receive keyboard focus.,**Gaming or Photography** can appear by sliding the bar in the middle. It does not receive keyboard focus.,Explicit,F54: Failure of Success Criterion 2.1.1 due to using only pointing-device-specific event handlers (including gesture) for a function,63.53%,3.37%,,,Blocking,TRUE,FALSE,,
...
ESC does not work to dismiss them.",,"SCR39: Making content on focus or hover hoverable, dismissible, and persistent",1.18%,0.01%,,,,FALSE,FALSE,,
...
They are coded as 'role=""tab""' but they don't have a parent with 'role=""tablist""",Implicit,ARIA4: Using a WAI-ARIA role to expose the role of a user interface component,88.24%,8.36%,,,Minor,TRUE,FALSE,,
...
When they are not selected, the text don't meet the contrast requirement even though they are not in disabled state",Implicit,G18: Ensuring that a contrast ratio of at least 4.5:1 exists between text (and images of text) and background behind the text,89.41%,5.70%,,,Major,TRUE,FALSE,,
135,TRUE,Done: Verified by PM,https://a11y-test.com/search,S2: Searching a Product and adding to Cart,,,3.3.2 Labels or Instructions,Control has no programmatic name/label.,Search icon is unlabelled,Explicit,F1: Failure of Success Criterion 1.3.2 due to changing the meaning of content by positioning information with CSS,75.29%,5.46%,,,,TRUE,FALSE,,
...
Interacting with Price slider control and Price stepper control loses the focus and AJAXes so very hard for keyboard and screen reader users.",Implicit,,78.82%,4.94%,,,,TRUE,FALSE,,
...
It only announces the first product.",Explicit,F103: Failure of Success Criterion 4.1.3 due to providing status messages that cannot be programmatically determined through role or properties,67.06%,3.83%,,,,TRUE,FALSE,,
...
Screenreader remains silent.",Implicit,,2.35%,0.09%,,,,TRUE,FALSE,,
139,FALSE,Done: Verified by PM,https://a11y-test.com/products/mh40-wireless-silver-metal-navy-coated-canvas,S2: Searching a Product and adding to Cart,,,2.4.7 Focus Visible,Element does not change its appearance when it has focus.,Star controls in rating form do not change appearance when they receive focus.,Implicit,,56.47%,3.10%,,,,TRUE,FALSE,,
...
Screenreader does not announce it. Instead, it erroneously announced ""(1500) characters remaining""",Implicit,,49.41%,1.57%,,,,TRUE,FALSE,,
...
It does not display which form had what issue.",Implicit,,0.00%,0.00%,,,,TRUE,FALSE,,
...
On star control, screenreader announces just **Link, X of 5 stars**",Implicit,,62.35%,3.27%,,,,TRUE,FALSE,,
...
When the page visually updates the price, the focus is set back to the close button.",Implicit,,78.82%,4.94%,,,,TRUE,FALSE,,
145,FALSE,Not Implemented yet,,,,,,,Wrong spelling. 'aria-labeledby' is not a valid aria attribute,Implicit,,#N/A,#N/A,,,,FALSE,FALSE,,
146,TRUE,Done: Verified by PM,https://a11y-test.com/account/login,S5: Sign-up and Sign-in,,,3.3.1 Error Identification,Error notification is not announced by screen reader.,"When user enters wrong login credentials, screen reader announces nothing. Screen reader jumps to **skip to content**",Implicit,G83: Providing text descriptions to identify required fields that were not completed,49.41%,1.57%,,,,TRUE,FALSE,,
147,FALSE,Done: Verified by PM,https://a11y-test.com/pages/about-us,S6: Product Pages,,,1.3.1 Info and Relationships,Information is conveyed to screen readers as a data table when it isn’t.,table elements are used only to visually layout the **Please reach out to us via email.** and the email address.,Implicit,,20.00%,0.34%,,,,FALSE,FALSE,,
148,FALSE,Not Implemented yet,,,,,,,form missing a label,Implicit,,#N/A,#N/A,,,,FALSE,FALSE,,
149,FALSE,Not Implemented yet,,,,,,,Formatting expectation for birthdate is not explained. MM/DD/YYYY,Implicit,,#N/A,#N/A,,,,FALSE,FALSE,,
150,FALSE,Not Implemented yet,payment,,,,,,Alerts and messages popping up without aria-live,Implicit,,#N/A,#N/A,,,,FALSE,FALSE,,
...
**First Name** form has a visual label of **First Name (Optional)**. However, programmatic label is **Your name here**",Implicit,C27: Making the DOM order match the visual order,0.00%,0.00%,,,,FALSE,FALSE,,
152,FALSE,Not Implemented yet,,,,,,,missing form container,Implicit,,#N/A,#N/A,,,,FALSE,FALSE,,
153,FALSE,Not Implemented yet,,,,,,,Form has a label but it does not have 'for' attribute,Implicit,,#N/A,#N/A,,,,FALSE,FALSE,,
154,FALSE,Done: Verified by PM,https://a11y-test.com/account/register,,,,"4.1.2 Name, Role, Value","Inaccurate role, state, or value information supplied.",**Create account** button uses 'span' instead of '<input type=submit>' and contains wrong aria attribute 'aria-role=button',Implicit,,88.24%,8.36%,,,,FALSE,FALSE,,
155,FALSE,Done: Verified by PM,https://a11y-test.com/pages/about-us,S6: Product Pages,,,2.4.9 Link Purpose (Link Only),Link text is not unique.,**click here**,Implicit,,#N/A,#N/A,,,,FALSE,FALSE,,
...
157,TRUE,Done: Verified by PM,https://a11y-test.com/products/3-5mm-to-3-5mm-audio-cable-black,S6: Product Pages,,,4.1.1 Parsing,Does not follow programming syntax.,**mg20-gaming-galactic-white** image has an aria-labelledby attribute references an ID that doesn't exist.,Implicit,ARIA10: Using aria-labelledby to provide a text alternative for non-text content,31.76%,1.11%,,,,FALSE,FALSE,,
158,FALSE,Done: Verified by PM,https://a11y-test.com/pages/contact,S7: Contact,,,1.3.1 Info and Relationships,,Untagged PDF **Our old products** is used to convey additional information but no HTML or any accessible alternative.,Implicit,,#N/A,#N/A,,,,FALSE,FALSE,,
159,FALSE,Done: Verified by PM,https://a11y-test.com/pages/about-us,S6: Product Pages,,,1.1.1 Non-text Content,Decorative image is not hidden from screen readers.,**About us** has a green background on top. It is a decorative image but not hidden to screen readers,Implicit,,3.53%,0.09%,,,,FALSE,FALSE,,
160,TRUE,Done: Verified by PM,checkout/information,,,,1.1.1 Non-text Content,,Dropdown collapsed caret icon is only announced as **image**,Explicit,"F65: Failure of Success Criterion 1.1.1 due to omitting the alt attribute or text alternative on img elements, area elements, and input elements of type ""image""",#N/A,#N/A,,,,FALSE,FALSE,,
161,TRUE,Done: Verified by PM,checkout/shipping,,,,1.3.1 Info and Relationships,Data table's programmatic association between data and headers is not accurate/complete.,**Contact** and **Ship to** acts as an row header but not programmed as such.,Explicit,F91: Failure of Success Criterion 1.3.1 for not correctly marking up table headers,#N/A,#N/A,,,,TRUE,FALSE,,
162,TRUE,Done: Verified by PM,https://a11y-test.com/products/mh40-wireless-silver-metal-navy-coated-canvas,,,,2.4.3 Focus Order,Focus moves to a non-interactive control.,Each list item receives focus though they are not interactive,Implicit,G59: Placing the interactive elements in an order that follows sequences and relationships within the content,16.47%,0.36%,,,,FALSE,FALSE,,
163,FALSE,Done: Verified by PM,https://a11y-test.com/products/3-5mm-to-3-5mm-audio-cable-black,,,,2.1.4 Character Key Shortcuts,No method provided to turn off keyboard shortcuts or customize keyboard shortcuts,"The page uses ""C"" key activates the link to the contact page. No documentation on how to turn it off.",,F99: Failure of Success Criterion 2.1.4 due to implementing character key shortcuts that cannot be turned off or remapped,0.00%,0.00%,,,,FALSE,FALSE,,
164,FALSE,Done: Verified by PM,All products,,,,2.1.1 Keyboard,Control does not follow traditional keyboard behavior.,Change quantity **+** and **-** icon buttons get activated via keydown event.,,,#N/A,#N/A,,,,TRUE,FALSE,,
165,FALSE,Done: Verified by PM,checkout,,,,1.4.1 Use of Color,Element relies on color alone to convey meaning.,Payment flow breadcrumb indicates the current page only by color,,G183: Using a contrast ratio of 3:1 with surrounding text and providing additional visual cues on hover for links or controls where color alone is used to identify them,31.76%,0.56%,,,,FALSE,FALSE,,
167,FALSE,Done: Verified by PM,https://a11y-test.com/pages/checkout,,,,1.1.1 Non-text Content,Image does not provide a text alternative,Image of caret without text alternative is used on breadcrumb,,,67.06%,2.46%,,,,FALSE,FALSE,,
168,FALSE,Done: Verified by PM,https://a11y-test.com/pages/checkout,,,,2.4.6 Headings and Labels,Control has no programmatic name/label.,**Last name** input field does not have a label,,,75.29%,5.46%,,,,FALSE,FALSE,,
169,FALSE,Done: Verified by PM,https://a11y-test.com,,,,1.4.3 Contrast (Minimum),Does not meet the contrast minimum of 4.5:1 for regular text.,**You have been subscribed to our newsletter.** green does not meet contrast of 4.5:1,,G18: Ensuring that a contrast ratio of at least 4.5:1 exists between text (and images of text) and background behind the text,89.41%,5.70%,,,,FALSE,FALSE,,
170,FALSE,Done: Verified by PM,https://a11y-test.com/account/login,,,,1.3.1 Info and Relationships,Content does not specify landmarks for major regions,Main part of the page is not using 'main' landmark,,ARIA11: Using ARIA landmarks to identify regions of a page,20.00%,0.39%,,,,,,,
