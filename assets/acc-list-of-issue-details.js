...
const issueListObj = {
  ...
  '/pages/contact': [
    ...
    ['2.4.3 Focus Order','G59: Placing the interactive elements in an order that follows sequences and relationships within the content','"**Contact US** page has 4 items, **free shipping**, **Customer service**, Refer a friend**, and **Secure payment**. They are all not interactive but receive keyboard focus"']
  ],
  '/pages/about-us': [
